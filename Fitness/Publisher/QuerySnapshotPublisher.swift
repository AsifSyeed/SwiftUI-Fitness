...
extension Publishers {
    struct QuerySnapshotPublisher: Publisher {
        ...
        func receive<S>(subscriber: S) where S : Subscriber, FitnessError == S.Failure, QuerySnapshot == S.Input {
    ...
    class QuerySnapshotSubscription<S: Subscriber>: Subscription where S.Input == QuerySnapshot, S.Failure == FitnessError {
